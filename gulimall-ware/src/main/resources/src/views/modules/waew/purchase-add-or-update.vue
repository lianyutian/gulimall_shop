<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="assigneeId">
      <el-input v-model="dataForm.assigneeId" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="assigneeName">
      <el-input v-model="dataForm.assigneeName" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="phone">
      <el-input v-model="dataForm.phone" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="priority">
      <el-input v-model="dataForm.priority" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    <el-form-item label="${column.comments}" prop="amount">
      <el-input v-model="dataForm.amount" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/waew/purchase/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/waew/purchase/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
