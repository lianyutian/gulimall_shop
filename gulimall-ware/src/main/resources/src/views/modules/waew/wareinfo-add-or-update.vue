<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="address">
      <el-input v-model="dataForm.address" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/waew/wareinfo/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/waew/wareinfo/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
